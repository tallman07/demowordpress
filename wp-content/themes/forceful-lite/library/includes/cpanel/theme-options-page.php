    ...
    <form name="kopa-theme-options" id="kopa-theme-options" autocomplete="off" method="post" action="options.php">
        ...
        <div class="kopa-content">
            ...
            <div class="kopa-page-header clearfix">
                <div class="pull-left">
                    <h4><?php echo KopaIcon::getIcon('cog'); ?><?php _e('Theme Options', kopa_get_domain()); ?></h4>
                </div>
            ...
            <div class="kopa-actions clearfix">
                <div class="kopa-button">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i><?php _e('Save', kopa_get_domain()); ?></button>
                </div>
