	...
	<div class="container">
		...
		<div class="row hc_footer_area">
			...
			<p><?php  
					...
					<a target="_blank" rel="nofollow" href="<?php if($current_options['created_by_link']!='') { echo $current_options['created_by_link']; } ?>"><?php if($current_options['created_by_webriti_text']!='') { echo $current_options['created_by_webriti_text']; } ?></a></p>
			</div>			
		</div>
	</div>
<?php
